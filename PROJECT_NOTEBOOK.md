...
**به‌روزرسانی مهم (۱۴۰۵/۰۴/۲۱):** بانک سؤالات نمونه با بانک واقعی رهنمون ۱۴۰۵ جایگزین شد؛ مدل داده (schema.ts) کاملاً با ساختار `questions.json` یکی شد — نه adapter، نه فیلد اضافه. جزئیات در ADR-007. سپس بچ دوم (۱۳ سؤال ریاضی، شکل خام متفاوت) با `scripts/merge-batch.mjs` نُرمال و ادغام شد؛ بانک اکنون **۷۰ سؤال** دارد (ریاضیات ۳۵، کیمیا ۱۲، فزیک ۱۱، بیولوژی ۱۲). جزئیات در ADR-008.
