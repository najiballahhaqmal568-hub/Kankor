...
**مرحله فعال:** ✅ مرحله ۵ (کارنامه هوشمند) تکمیل شد — در حال شروع مرحله ۶ (مرور فاصله‌دار SM-2)
...
| ۶. مرور فاصله‌دار SM-2 | ⏳ در جریان |
| ۷. PWA + صیقل نهایی | ⬜ |

**تست‌ها:** ۱۲ تست واحد سبز (examEngine ۷ + analytics ۵). نمودار کارنامه از رنگ وضعیتی + برچسب عددی استفاده می‌کند (رنگ به‌تنهایی حامل معنا نیست).
| ۴. شبیه‌ساز آزمون | ⬜ |
| ۵. کارنامه هوشمند | ⬜ |
